...
class ChannelProvider(Protocol):
    ...
    async def aclose(self) -> None:
        """Libera a conexão HTTP subjacente. Cada chamador cria um provider por
        execução (worker de vida longa, task nova a cada mensagem) — sem isso o
        cliente HTTP fica aberto e vaza conexão a cada task."""
        ...
